...
(use-package general :ensure t
  ...
  (general-define-key
   ...
   "'"   '(my-run-term :which-key "terminal")
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(emmet-mode yasnippet-snippets yasnippet company evil-magit magit multi-term vterm projectile which-key rainbow-delimiters doom-modeline doom-themes counsel ivy use-package)))
(custom-set-faces
